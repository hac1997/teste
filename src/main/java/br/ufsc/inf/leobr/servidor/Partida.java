...
public class Partida {
	...
	/**
	 * Retorna o jogador dono de uma partida. O jogador dono � o jogador que
	 * iniciou a partida e � sempre o primeiro a jogar.
	 * 
	 * @return
	 */
	...
	/**
	 * @param qualJogador
	 * @return true se o jogador est� participando da partida e false caso
	 *         contr�rio
	 */
	...
	/**
	 * Envia mensagens para os dois jogadores informando que o jogo come�ou e
	 * informando que � o advers�rio
	 */
	public void iniciaPartida(ServerHandler jogadorPedinte) {

		// Se o cliente n�o definiu uma ordem espec�fica
	...
	public void efetuaJogada(ServerHandler jogadorEfetuante,
        ...
        List<ServerHandler> jogadoresLista = new ArrayList<ServerHandler>(this.jogadores);
